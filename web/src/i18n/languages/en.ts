...
export const strings = {
  ...
  "do.rebase": "Rebase onto {onto}",
  "do.abort": "Abort {operation}",
  "do.continue": "Continue {operation}",
  "do.checkout": "Switch to {name}",
  "do.openFile": "Open {file}",
  "do.stash": "Stash",
  "do.stashApply": "Apply {where}",
